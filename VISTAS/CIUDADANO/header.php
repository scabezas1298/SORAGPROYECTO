...
?>
<?php
require_once '../../controlador/ciudadano/actualizar_ciudadano.php';
?>
...
<header id="main-header" class="custom-header">
    ...
    <nav class="nav-bar">
        <ul>
            <li>
                <a href="ciudadano.php" class="nav-link" data-page="ciudadano.php" >Inicio</a>
            </li>
            <li>
                <a href="solicitudes.php" class="nav-link" data-page="solicitudes.php">Solicitudes</a>
            </li>
            <li>
                <a href="perfil.php" class="nav-link" data-page="perfil.php">Perfil</a>
            </li>
            <li>
